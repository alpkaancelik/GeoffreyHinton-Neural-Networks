...
model.embed_to_hid_weights = 0 % embed_to_hid_weights;
model.hid_to_output_weights = 0 % hid_to_output_weights;
model.hid_bias = 0 %hid_bias;
model.output_bias = 0 %output_bias;
model.vocab = vocab;
